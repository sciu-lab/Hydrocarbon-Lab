...
const ENGLISH_UI: Record<string, string> = {
  ...
  "Selecciona un átomo para editarlo": "Select an atom to edit it",
  ...
  "Construir por nombre químico": "Build from chemical name",
  "Por nombre": "By name",
  "Por fórmula molecular": "By molecular formula",
  "Generar isómeros desde una fórmula molecular": "Generate isomers from a molecular formula",
  ...
  "Cargar en el canvas": "Load on canvas",
  "Estructura de": "Structure of",
  "Enumeración completa de isómeros constitucionales para esta fórmula dentro del alcance orgánico indicado.": "Complete enumeration of constitutional isomers for this formula within the stated organic scope.",
  "Catálogo representativo: esta fórmula admite más isómeros. No se presenta como una enumeración exhaustiva.": "Representative catalog: this formula has more isomers. This is not presented as an exhaustive enumeration.",
  "Escribe una fórmula molecular. Ejemplo: C6H12O.": "Enter a molecular formula. Example: C6H12O.",
  "La fórmula no tiene un formato válido. Usa, por ejemplo, C6H12O.": "The formula is not in a valid format. Use, for example, C6H12O.",
  "Este constructor orgánico requiere al menos un átomo de carbono.": "This organic builder requires at least one carbon atom.",
  "La fórmula produce un IDH imposible para una molécula orgánica neutra y cerrada.": "The formula produces an impossible DoU for a neutral, closed-shell organic molecule.",
  ...
  "Ampliar": "Expand",
  "Acciones del canvas": "Canvas actions",
  "Exportar PNG": "Export PNG",
  "Descargar canvas como imagen PNG": "Download canvas as a PNG image",
  "Exportar PNG/SVG": "Export PNG/SVG",
  "Exportar canvas como imagen PNG o SVG": "Export canvas as a PNG or SVG image",
  "Exportar imagen": "Export image",
  "Elige la resolución y el fondo antes de descargar.": "Choose the resolution and background before downloading.",
  "Cerrar opciones de exportación PNG": "Close PNG export options",
  "Elige el formato, el tamaño, el fondo y el modo de color antes de descargar.": "Choose the format, size, background, and color mode before downloading.",
  "Cerrar opciones de exportación de imagen": "Close image export options",
  "Vista previa de exportación": "Export preview",
  "Formato": "Format",
  "Imagen por píxeles": "Pixel image",
  "Vector escalable": "Scalable vector",
  "Selección activa": "Active selection",
  "Exportar con el átomo o grupo seleccionado": "Export with the selected atom or group",
  "No hay una selección activa en el canvas.": "There is no active selection on the canvas.",
  "Desmárcalo para ocultar el halo de selección en la imagen.": "Uncheck this to hide the selection halo from the image.",
  "Quitar la selección del canvas": "Clear the canvas selection",
  "Resolución": "Resolution",
  "Tamaño PNG": "PNG size",
  "Ancho": "Width",
  "Alto": "Height",
  "Ancho del PNG en píxeles": "PNG width in pixels",
  "Alto del PNG en píxeles": "PNG height in pixels",
  "Mantener proporción": "Keep aspect ratio",
  "Puedes escribir un tamaño exacto entre 200 y 8000 píxeles.": "You can enter an exact size between 200 and 8000 pixels.",
  "Estándar": "Standard",
  "Alta": "High",
  "Máxima": "Maximum",
  "Fondo": "Background",
  "Con fondo": "With background",
  "Sin fondo": "No background",
  "Usa el color del canvas actual.": "Uses the current canvas color.",
  "Conserva la transparencia del PNG.": "Keeps the PNG transparent.",
  "Conserva la transparencia del archivo.": "Keeps the exported file transparent.",
  "Cancelar": "Cancel",
  ...
  "Conserva los colores elegidos en el canvas.": "Keeps the colors selected on the canvas.",
  "Permite elegir colores para la imagen exportada.": "Lets you choose colors for the exported image.",
  "Convierte la imagen a grises para imprimir.": "Converts the image to grayscale for printing.",
  "Usa alto contraste para fotocopias e impresoras.": "Uses high contrast for photocopies and printers.",
  "Colores de exportación": "Export colors",
  "Estos colores se aplican solo al archivo exportado.": "These colors apply only to the exported file.",
  "Grupo funcional": "Functional group",
  "Elegir color de cadena principal": "Choose the main chain color",
  "Elegir color de grupo funcional": "Choose the functional group color",
  "Elegir color de sustituyentes": "Choose the substituent color",
  "La imagen PNG de la molécula se descargó correctamente.": "The molecule PNG image was downloaded successfully.",
  "No fue posible exportar el canvas como imagen PNG.": "The canvas could not be exported as a PNG image.",
  "La imagen SVG de la molécula se descargó correctamente.": "The molecule SVG image was downloaded successfully.",
  ...
  "OPSIN interpreta nombres sistemáticos; PubChem resuelve sinónimos y OpenChemLib crea la estructura editable.": "OPSIN interprets systematic names; PubChem resolves synonyms, and OpenChemLib creates the editable structure.",
  ...
  "Colores de la estructura": "Structure colors",
  "Personaliza los colores de la cadena principal y de sus sustituyentes.": "Customize the colors of the parent chain and its substituents.",
  "Elegir color de la cadena principal": "Choose parent-chain color",
  "Elegir color de los sustituyentes": "Choose substituent color",
  "Restaurar colores": "Reset colors",
  "Se restauraron los colores predeterminados de la estructura.": "The structure's default colors were restored.",
  ...
  "Opciones del enlace seleccionado": "Selected bond options",
  "La configuración R/S pertenece al átomo; este enlace solo porta el wedge/hash.": "R/S belongs to the atom; this bond only carries the wedge/hash.",
  "Estereoquímica R/S": "R/S stereochemistry",
  "Centro atómico · enlace portador": "Atomic center · carrier bond",
  "Configuración actual": "Current configuration",
  "Sin configuración asignada": "No configuration assigned",
  "Configurar centro": "Configure center",
  "Invertir": "Invert",
  "Eliminar": "Remove",
  ...
  "Heterociclos aromáticos": "Aromatic heterocycles",
  "Heterociclos saturados": "Saturated heterocycles",
  "Anillos con N, O o S": "Rings containing N, O, or S",
  "Anillos con N u O": "Rings containing N or O",
  "Benceno": "Benzene",
  "Tolueno": "Toluene",
  ...
  "Uso": "Use",
  "Buscando contexto…": "Looking up context…",
  "Saber más en PubChem": "Learn more on PubChem",
  ...
  "Ver ficha en PubChem": "View record on PubChem",
  "Masa molar": "Molar mass",
  "Donadores H": "H-bond donors",
  "Aceptores H": "H-bond acceptors",
  "Enlaces rotables": "Rotatable bonds",
  ...
  "Cuando hay una función de sufijo, esta define el sufijo y recibe prioridad en la numeración. Nitro se expresa como prefijo.": "When a suffix function is present, it determines the suffix and takes numbering priority. Nitro is cited as a prefix.",
  ...
  "Mostrar etiquetas de anillos esteroideos": "Show steroid ring labels",
  "Muestra las letras A–D solo para el núcleo esteroideo reconocido": "Shows A–D only for the recognized steroid nucleus",
  ...
  "Ajusta el círculo y la letra de los centros tetraédricos": "Adjusts the circle and letter of tetrahedral centers",
  "Restablecer": "Reset",
  ...
  "Mostrar nombre completo": "Show full name",
  "Copiar": "Copy",
...
const dynamicExact: Record<string, string> = {
  ...
  "Escribe un nombre químico para crear la estructura.": "Enter a chemical name to create the structure.",
  "No pude interpretar ese nombre químico.": "I could not interpret that chemical name.",
  "La estructura contiene estereoquímica tetraédrica que el canvas no puede representar de forma inequívoca; se conserva la conectividad, pero no se afirma una identidad estereoquímica exacta.": "The structure contains tetrahedral stereochemistry that the canvas cannot represent unambiguously; connectivity is preserved, but an exact stereochemical identity is not claimed.",
  "PubChem encontró varias estructuras posibles para ese nombre común.": "PubChem found several possible structures for that common name.",
  "Usa un nombre más específico o incluye los descriptores estereoquímicos necesarios.": "Use a more specific name or include the required stereochemical descriptors.",
  "PubChem no encontró una estructura inequívoca y compatible para ese nombre.": "PubChem did not find an unambiguous compatible structure for that name.",
  "No fue posible conectar con PubChem.": "Could not connect to PubChem.",
  "Prueba un sinónimo más específico o un nombre sistemático.": "Try a more specific synonym or a systematic name.",
  "OPSIN y PubChem no pudieron resolver ese nombre de forma inequívoca.": "OPSIN and PubChem could not resolve that name unambiguously.",
  ...
  "El nombre del derivado von Baeyer contiene prefijos, localizadores o sufijos no admitidos.": "The von Baeyer derivative name contains unsupported prefixes, locants, or suffixes.",
  ...
  "Los localizadores funcionales o de sustituyentes no son válidos para este policiclo.": "The functional-group or substituent locants are not valid for this polycycle.",
  "Una insaturación cita un carbono inexistente en el descriptor von Baeyer.": "An unsaturation cites a carbon that does not exist in the von Baeyer descriptor.",
  "Una insaturación no corresponde a un enlace único del núcleo policíclico.": "An unsaturation does not correspond to a unique bond in the polycyclic core.",
  "No fue posible colocar el grupo funcional en el carbono indicado.": "The functional group could not be placed on the specified carbon.",
  "La combinación indicada produce una conectividad o valencia no válida.": "The specified combination produces invalid connectivity or valence.",
